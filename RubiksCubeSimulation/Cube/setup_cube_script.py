...
def setup_cube():
    ...
    piece.set_colors('x', 'white')
    piece.set_colors('y', 'blue')
    piece.set_colors('z', 'red')
    pieces.add(piece)
    ...
    piece.set_colors('x', 'white')
    piece.set_colors('y', 'orange')
    piece.set_colors('z', 'blue')
    pieces.add(piece)
    piece = Piece(x, -1, 0) # Front 3
    piece.rotate('x', 2, rotate_position=False)
    piece.set_colors('x', 'white')
    piece.set_colors('y', 'red')
    pieces.add(piece)
    ...
    piece.set_colors('x', 'white')
    piece.set_colors('y', 'red')
    piece.set_colors('z', 'green')
    pieces.add(piece)
    piece = Piece(x, 0, -1) # Front 7
    piece.rotate('x', -1, rotate_position=False)
    piece.set_colors('x', 'white')
    piece.set_colors('y', 'green')
    pieces.add(piece)
    piece = Piece(x, 1, -1) # Front 8
    piece.rotate('x', -1, rotate_position=False)
    piece.set_colors('x', 'white')
    piece.set_colors('y', 'green')
    piece.set_colors('z', 'orange')
    pieces.add(piece)
    ...
    piece.set_colors('x', 'red')
    piece.set_colors('y', 'blue')
    pieces.add(piece)
    piece = Piece(x, 0, 1) # Middle 1
    piece.rotate('y', -1, rotate_position=False)
    piece.set_colors('x', 'blue')
    pieces.add(piece)
